...
export const GIFFIcon = ({ className }) => {
    return <Svg className={className}>
...
export const KonumIcon = ({ className }) => {
    return <Svg className={className}>
